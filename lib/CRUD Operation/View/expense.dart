          ...
          child: Padding(
            ...
            child: Obx(
                ...
                children: [
                  ...
                  Text(
                    'Expense Overview : ${((controller.totalIncome.value + controller.totalExpense.value > 0) ? (controller.totalExpense.value / (controller.totalIncome.value + controller.totalExpense.value)) * 100 : 0.0).toStringAsFixed(2)} %',
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                            ...
                            itemBuilder: (context, index) {
                              if(controller.data[index]['isIncome'] == 0){
                                return Padding(
